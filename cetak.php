            ...
            ?>
                <section id="main-content">
                    <section class="wrapper">
                        <h3>
                            <center><i class="fa fa-angle"></i> CETAK DATA PEMOHON </center>
                        </h3>
                        <!-- BASIC FORM ELELEMNTS -->
                        <div class="row row modal-title">
                            <div class="col-lg-12">
                                <form class="form-horizontal style-form" method="POST" action="proses_cetak.php">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="3" class="form-control" name="kebangsaan" readonly value="<?php echo $data['kebangsaan']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <font color="black"><label class="col-sm-1 col-sm-1 control-label">Agama</label></font>
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" name="agama" readonly value="<?php echo $data['agama']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <font color="black"> <label class="col-sm-1 col-sm-1 control-label">TTL</label>
                                            <font color="black">
                                                <div class="col-sm-1">
                                                    <input type="text" class="form-control" name="tempat" readonly value="<?php echo $data['tempat']; ?>">
                                                </div>
                                                <div class="col-sm-2">
                                                    <input type="date" class="form-control" name="tanggal_lahir" readonly value="<?php echo $data['tanggal_lahir']; ?>">
                                                </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" name="pekerjaan" readonly value="pekerjaan">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <font color="black"> <label class="col-sm-1 col-sm-1 control-label">NIK</label></font>
                                        <div class="col-sm-3">
                                            <input type="number" class="form-control" name="nik" readonly value="<?php echo $data['nik']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <font color="black"> <label class="col-sm-1 col-sm-1 control-label">Keperluan</label></font>
                                        <div class="col-sm-3">
                                            <input type="text" class="form-control" name="keperluan" readonly value="<?php echo $data['keperluan']; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
